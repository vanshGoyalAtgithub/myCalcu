...
class App extends WindowAdapter implements ActionListener {
    ...
    Button badd, bsubb, bmult, bdiv, bmod, bclac, bclr, bpts, bneg, bback;
    double xd;
    ...
    App() {
        ...
        bclac = new Button("=");
        bclac.setBounds(245, 410, 65, 50);
        bclr = new Button("CE");
        // here two buttons are missing
        bsubb = new Button("-");
        ...
        bsubb.addActionListener(this);
        bmult.addActionListener(this);
        bdiv.addActionListener(this);
        bmod.addActionListener(this);
        bclac.addActionListener(this);
        bclr.addActionListener(this);

        f.setBackground(new Color(50, 89, 120));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // subtraction button functionl;ity
        if (e.getSource() == bsubb) {
            try {
                num1 = Double.parseDouble(l1.getText());
